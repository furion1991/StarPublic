...
export const Multiplier = ({ multiplier }: MultiplierProps) => {
  return (
          ...
          >
            <stop
              className={cn(classes.bgColor, {
                [classes.purple]: multiplier >= 1 && multiplier <= 2,
                [classes.green]: multiplier >= 2 && multiplier <= 3,
                [classes.yellow]: multiplier >= 3 && multiplier <= 4,
                [classes.red]: multiplier >= 4
              })}
            />
